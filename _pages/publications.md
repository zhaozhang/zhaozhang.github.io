...
- [MLSys'25] Zheng, Mingkai, and Zhao Zhang. ["Radius: Range-based Gradient Sparsity for Large Foundation Model Pre-training."](https://openreview.net/pdf?id=UCQPWBOWb6) In Eighth Conference on Machine Learning and Systems. 2025.
